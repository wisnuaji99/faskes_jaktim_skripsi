                ...
                <div class="card-body">
                    <form action="{{ route('admin.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name) }}" placeholder="Masukkan Nama Role"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" name="roles[]" value="{{ $role->name }}" id="check-{{ $role->id }}" @if($user->roles->contains($role->id)) checked @endif>
