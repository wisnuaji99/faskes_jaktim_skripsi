...
<head>
    ...
    <title>Dashboard &mdash; FASILITAS KESEHATAN JAKARTA TIMUR </title>
    <link rel="shortcut icon" href="{{ asset('assets/img/hospital-logo.svg') }}" type="image/x-icon">
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('admin.dashboard.index') }}">FASKES JAKTIM</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="{{ route('admin.dashboard.index') }}">FASKES</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li
                            class="dropdown {{ setActive('kelurahan'). setActive('kecamatan')}}">
                            @if(auth()->user()->can('kelurahans.index') || auth()->user()->can('kecamatans.index'))
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i><span>Wilayah</span></a>
                            @endif
 
                            <ul class="dropdown-menu">
                                @can('kecamatans.index')
                                    <li class="{{ setActive('kecamatan') }}"><a class="nav-link"
                                    href="{{ route('kecamatan.index') }}"><i class="fas fa-landmark"></i>
                                    Kecamatan</a></li>
                                @endcan

                                @can('kelurahans.index')
                                    <li class="{{ setActive('kelurahan') }}"><a class="nav-link"
                                        href="{{ route('kelurahan.index') }}"><i class="fas fa-building"></i> Kelurahan</a>
                                </li>
                                @endcan
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2018 <div class="bullet"></div> Wisnu Aji <div class="bullet"></div> All Rights
                    Reserved.
                </div>
